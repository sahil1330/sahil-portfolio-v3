...
export function MotionController() {
  useEffect(() => {
    ...
    const context = gsap.context(() => {
      ...
      if (heroCopy && phaseLabels.length === 2) {
        ...
        ScrollTrigger.create({
          ...
          onUpdate: ({ progress }) => {
            const systemsOpacity = chapterOpacity(progress, 0.25, 0.34, 0.51, 0.6);
            const infrastructureOpacity = chapterOpacity(progress, 0.59, 0.68, 0.86, 0.95);
            const introOpacity = 1 - ramp(progress, 0.16, 0.27);
            ...
            gsap.set(phaseLabels[1], {
              autoAlpha: infrastructureOpacity,
              y: 28 * (1 - infrastructureOpacity),
            });
          },
        });
      }
